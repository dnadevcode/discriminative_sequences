function [] = local_pipeline_boosted(ix,dirName,depth,windowWidths)
%   local_pipeline_boosted - local pipeline, but boosted for quicker
%   results. In the first iteration run single length re-scaling factor to
%   remove certainly non-distinct matches. Then the first step will be most
%   time consuming
